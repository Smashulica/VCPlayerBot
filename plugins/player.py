...
async def not_chat(_, m: Message):
    if m.from_user is not None and m.from_user.id in Config.SUDO:
        ...
        buttons = [
            [
                InlineKeyboardButton('⚡️Copy this BOT 1/1', url='https://www.youtube.com/watch?v=dQw4w9WgXcQ'),
                InlineKeyboardButton('🧩 Join Here', url='https://t.me/OTRportal'),
            ]
            ]
        await m.reply("<b>Sa iti dam la m**e 🖕, nu poti folosi botu in alt grup decat pe @filme4kpetelegram @OTRportal @LupiiDinHaita si @GrupuriRomanesti sau il poti copia singur folosind sursa de [SOURCE CODE](https://www.youtube.com/watch?v=dQw4w9WgXcQ) aici.</b>", disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(buttons))
